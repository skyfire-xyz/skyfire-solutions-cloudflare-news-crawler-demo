...
interface CrawlSearchLogProps {
  ...
  onCloudflareUrlChange?: (url: string) => void;
}

const channelId = uuidv4();

export default function CrawlSearchLog({ skyfireKyaToken, onCloudflareUrlChange }: CrawlSearchLogProps) {
      ...
      <div className="bg-blue-50 rounded-lg border border-gray-200 p-4 pb-0 shadow-sm">
        <div className="mb-4">
          ...
          <SearchBar
            ...
            onCloudflareUrlChange={onCloudflareUrlChange}
          />
        </div>
      </div>
