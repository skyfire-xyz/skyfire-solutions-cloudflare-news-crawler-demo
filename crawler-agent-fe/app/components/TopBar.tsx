...
export default function TopBar({
  selectedUrl,
  showCloudflareLink: showCloudflareLinkProp,
}: TopBarProps) {
  const showCloudflareGithubLink =
    !!selectedUrl && CLOUDFLARE_URLS.includes(selectedUrl)
  const showCloudflareLink =
    typeof showCloudflareLinkProp === "boolean"
      ? showCloudflareLinkProp
      : showCloudflareGithubLink
      ...
      <div className="container mx-auto px-4 py-0">
        <div className="max-w-4xl">
          ...
          <div className="mb-6 flex gap-6">
            ...
            <div className="flex items-start gap-3">
              <svg
                className="mt-0.5 size-5 flex-shrink-0 text-green-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          {showCloudflareLink && (
            <div className="mb-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-gray-800 px-4 py-2 text-sm text-white transition hover:bg-gray-700"
              >
                Cloudflare Reference Implementation: GitHub
              </a>
            </div>
          )}
